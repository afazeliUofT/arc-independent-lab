...
broker_module = _module("p3_review_interface_028")
protocol = _module("p3_review_protocol_028")
...
def run_session(plan, run, requested, broker, *, mode, prompt, wall_seconds,
    ...
    """
    run = Path(run)
    report = {"kind": "P3_FINITE_REVIEWER_SESSION_028_v1", "mode": mode,
              ...
              "broker_boundary_failure": None, "recoverable_input_errors": 0,
