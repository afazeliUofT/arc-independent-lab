"""Local checkpoint-003 ZIP handoff. No commit, push, fetch, or authentication.
...
BASE = "6c69eca83cadd0346d85110af470a61f3f075d5d"
...
def load_package(path, expected_hash):
    ...
    with zipfile.ZipFile(path) as archive:
        ...
        if (set(manifest) != {"checkpoint_id", "base_commit", "files"}
                or manifest["checkpoint_id"] != "P1_CHECKPOINT_003"
...
def apply(root, files):
    ...
    if head != BASE:
        ...
        return
    backup_parent = ordinary(root, "delivery/checkpoint003_backups", directory=True)
