#!/usr/bin/env python3
"""Collect the fixed, noncredential 032 evidence files; never run Git or a model.
...
VERSION = "P3_REVIEW_032_EVIDENCE_COLLECTION_032_v1"
...
ARCHIVE_PARENT = "artifacts/P3_REVIEW_032_RETURN"
...
def _summary(entries):
    ...
    if any(value == "REFUSED" for value in states.values()):
        ...
        collection = "WORKFLOW_EVIDENCE_ONLY_NO_032_RECEIPTS"
    elif report != "PRESENT":
    ...
    return {"collection_status": collection, "main_report": report,
            ...
            "original032_file_count": original_count,
