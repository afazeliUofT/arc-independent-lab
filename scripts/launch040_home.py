#!/usr/bin/env python3
"""Install the verified040 outer ZIP under the existing WSL lab and run its finite review workflow.
...
STEM = 'delivery/P3_CHECKPOINT_040'
MAX_ARCHIVE, MAX_FILE, MAX_TOTAL, MAX_MEMBERS = 64 << 20, 32 << 20, 128 << 20, 512
ROOT_FILES = {'SHA256SUMS', 'RELEASE.json', 'launch040_home.py', 'README_040.md'}
BOOT_SCRIPTS = {'scripts/review040_workflow.py', 'scripts/publish_review040_evidence.py',
...
def launch(raw, archive_path='', *, home=None, runner=None):
    ...
    result = execute([sys.executable, '-B', '-u', str(bundle / 'scripts/review040_workflow.py'),
