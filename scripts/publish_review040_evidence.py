#!/usr/bin/env python3
"""Collect the fixed, noncredential 040 evidence files; never run Git or a model.
...
VERSION = "P3_REVIEW_040_EVIDENCE_COLLECTION_040_v1"
...
ARCHIVE_PARENT = "artifacts/P3_REVIEW_040_RETURN"
...
def _summary(entries):
    ...
    if any(value == "REFUSED" for value in states.values()):
        ...
        collection = "WORKFLOW_EVIDENCE_ONLY_NO_040_RECEIPTS"
    elif report != "PRESENT":
    ...
    return {"collection_status": collection, "main_report": report,
            ...
            "original040_file_count": original_count,
...
def bulk_copy_guard(root_fd, verdict):
    ...
    for source_id in ('CHV79', 'PK97'):
        name = 'delivery/P3_FOCUSED_REVIEW_PACKET_040/reading/' + source_id + '/full_text.txt'
        try:
