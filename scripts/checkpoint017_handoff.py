"""Local P3 checkpoint-017 ZIP handoff. No commit, push, fetch, or authentication.
...
BASE = "6cae5d3c8f1ac3ed2745415924eb478ee53e5951"
...
def load_package(path, expected_hash):
    ...
    with zipfile.ZipFile(path) as archive:
        ...
        if (set(manifest) != {"checkpoint_id", "base_commit", "files"}
                or manifest["checkpoint_id"] != "P3_CHECKPOINT_017"
...
def apply(root, files):
    ...
    if head != BASE:
        ...
        return
    backup_parent = ordinary(root, "delivery/checkpoint017_backups", directory=True)
