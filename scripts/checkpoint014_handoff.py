"""Local P3 checkpoint-014 ZIP handoff. No commit, push, fetch, or authentication.
...
BASE = "69d70dfb0dd49d51b223c57e29ea25295750e651"
...
def load_package(path, expected_hash):
    ...
    with zipfile.ZipFile(path) as archive:
        ...
        if (set(manifest) != {"checkpoint_id", "base_commit", "files"}
                or manifest["checkpoint_id"] != "P3_CHECKPOINT_014"
...
def apply(root, files):
    ...
    if head != BASE:
        ...
        return
    backup_parent = ordinary(root, "delivery/checkpoint014_backups", directory=True)
