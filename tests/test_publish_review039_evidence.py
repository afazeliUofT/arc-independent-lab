...
SPEC = importlib.util.spec_from_file_location('publisher039_fixture', ROOT / 'scripts/publish_review039_evidence.py')
...
class PublisherTests(unittest.TestCase):
    ...
    def test_bulk_private_passage_refused_with_verdict_kept_private(self):
        ...
        for source_id in ('CHV79', 'PK97'):
            path = self.root / 'delivery/P3_FOCUSED_REVIEW_PACKET_039/reading' / source_id / 'full_text.txt'
