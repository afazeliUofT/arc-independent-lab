...
import p3_reviewer_session_020 as s

BASE = ROOT / "delivery/p3_reviewer_session_020_tests"
...
class SessionTests(unittest.TestCase):
    ...
    def test_module_import_with_python_isolation_needs_no_script_search_path(self):
        code = "import importlib.util; p=" + repr(str(ROOT / "scripts/p3_reviewer_session_020.py")) + "; s=importlib.util.spec_from_file_location('session_isolation_test',p); m=importlib.util.module_from_spec(s); s.loader.exec_module(m); print(m.CLEANUP_SECONDS)"
